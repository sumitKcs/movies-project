        ...
        {getFavData === null ? (
          <>
            <div className="fav-no-data">
              <span className="no-fav-msg">No Favourites Found</span>
              <div className="no-fav-button">
                <button
          ...
          getFavData.map((media, index) => {
            return (
              <div className="fav-card" key={index}>
                <div
                  className="fav-image-container"
                  onClick={() =>
                    navigate(`/id/${media.media_type}/${media.id}`)
                  }
                >
                  <img
                    className="fav-image"
                    src={`https://image.tmdb.org/t/p/original${media.poster_image}`}
                    alt="..."
                  />
                </div>
                <div className="fav-media-details">
                  ...
                  <div className="fav-release-date">
                  ...
                  <button
                    type="button"
                    className="btn btn-secondary btn-lg btn-block fav-delete-button"
                    onClick={() => removeFromFav(media.id)}
                  >
